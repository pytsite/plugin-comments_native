$(window).on('pytsite.widget.init:plugins.comments_native._widget.Comments', function (e, widget) {
    var em = widget.em;
    ...
    function onBtnDeleteClick(btn, commentSlot) {
        if (confirm(t('comments_native@confirm_comment_deletion'))) {
            pytsite.httpApi.delete(em.data('commentSubmitEp') + '/' + commentSlot.data('uid')).done(function (r) {
                if (r['status']) {
    ...
    function onBtnReportClick(commentUid) {
        if (confirm(t('comments_native@confirm_comment_report'))) {
            pytsite.httpApi.post(em.data('commentReportEp') + '/' + commentUid).done(function () {
